...
import { BillImageAnalyzer } from '@/components/BillImageAnalyzer'
          ...
          <div className="lg:col-span-2 animate-slide-in-left">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-green-100/50 p-6 md:p-8 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-green-900">Upload Bill</h2>
                  <p className="text-green-600/80 text-sm">Scan grocery bill and add items to your pantry</p>
                </div>
              </div>
              <p className="text-green-700/90 mb-8 leading-relaxed">
                Upload your grocery bill and all the items will be generated.
                Modify items or quantities if you feel it's incorrect.
              </p>
              <BillImageAnalyzer />
            </div>
          </div>
